...
exclusion_reasons_husbandry[c(2, 4, 6, 7, 9, 10, 12, 14, 15, 23)] <- "more intensive farming"
exclusion_reasons_husbandry[c(12,22)] <- "missingness indicator"
exclusion_reasons_husbandry[c(20,8)] <- "explained by Weaners_on_farm"
exclusion_reasons_husbandry[11] <- "explained by cross_fostering_farrowign_stable_2"
exclusion_reasons_husbandry[24] <- "explained by seperation_quarantine_area_3"
