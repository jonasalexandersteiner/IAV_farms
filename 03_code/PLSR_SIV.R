...
meta_vars <- c("farm_id", "total_no_of_samples", "no_positive_pigs",
               "percentage_positive_pigs", "date_sampling", "SIV_positive", "min_cp", "max_cp", "average_cp", "std_dev")
...
custom_refs <- c(
  ...
  quarantaine_time = "quarantaine_time_20",
  litter_equalization_farrowing_stable = "litter_equalization_farrowing_stable_1",
  cleaning_ai_centre = "cleaning_ai_centre_3",
  cleaning_fattener_stable = "cleaning_fattener_stable_3",
  cleaning_quarantaine = "cleaning_quarantaine_3",
  desinfection_farrowing_stable = "desinfection_farrowing_stable_3",
  desinfection_weaner_stable = "desinfection_weaner_stable_3",
  ...
  seperation_quarantaine_area = "seperation_quarantaine_area_1",
  ...
  gilts_qm_per_animal = "gilts_qm_per_animal_>=6.0",
  gitls_animals_per_water_source = "gitls_animals_per_water_source_<4",
  gilts_room_temperature = "gilts_room_temperature_13–<17",
  gilts_airflow = "gilts_airflow_<0.1",
  gilts_air_quality = "gilts_air_quality_1",
  gilts_airspace_with_other_agegroup = "gilts_airspace_with_other_agegroup_1",
  ...
  fatteners_sneezing = "fatteners_sneezing_0–<2",
  fatteners_coughing = "fatteners_coughing_0–<2",
  fatteners_qm_per_animal = "fatteners_qm_per_animal_>=1.5",
  fatteners_feeding_site_per_animal_factor = "fatteners_feeding_site_per_animal_factor_over 25cm trough/animal",
  fatteners_animals_per_water_source = "fatteners_animals_per_water_source_<10",
  fatteners_room_temperature = "fatteners_room_temperature_15–<20",
  fatteners_airflow = "fatteners_airflow_<0.1",
  fatteners_air_quality = "fatteners_air_quality_1",
  fatteners_airspace_with_other_agegroup = "fatteners_airspace_with_other_agegroup_2"
)
...
custom_refs_reasons <- c(
  ...
  quarantaine_time = "longest quarantaine",
  litter_equalization_farrowing_stable = "never done as lowest risk for SIV due to best lactogen immunity",
  ...
  cleaning_quarantaine = "always clean after emptying, best practice",
  desinfection_farrowing_stable = "always desinfect after emptying, best practice for AIAO",
  desinfection_weaner_stable = "always desinfect after emptying, best practice for AIAO",
  ...
  seperation_quarantaine_area = "lowest risk for transmission by using seperate buildings",
  ...
  gilts_qm_per_animal = "lowest stocking density leading to lowest risk of transmission",
  gitls_animals_per_water_source = "lowest stocking density leading to lowest risk of transmission",
  gilts_room_temperature = "best practice temperature",
  gilts_airflow = "best practice to minimize any airflow",
  gilts_air_quality = "best air quality",
  gilts_airspace_with_other_agegroup = "lowest risk for transmission by using seperate buildings",
  ...
  fatteners_sneezing = "lowest prevalence leading to lowest SIV risk",
  fatteners_coughing = "lowest prevalence leading to lowest SIV risk",
  fatteners_qm_per_animal = "lowest stocking density leading to lowest risk of transmission",
  fatteners_feeding_site_per_animal_factor = "lowest stocking density leading to lowest risk of transmission",
  fatteners_animals_per_water_source = "lowest stocking density leading to lowest risk of transmission",
  fatteners_room_temperature = "best practice temperature",
  fatteners_airflow = "best practice to minimize any airflow",
  fatteners_air_quality = "best air quality",
  fatteners_airspace_with_other_agegroup = "lowest risk for transmission by using seperate buildings, but including fattening on farm"
)
...
if ("outside_area_gilts_stable_TRUE" %in% colnames(X)) custom_cols <- c(custom_cols, "outside_area_gilts_stable_TRUE")
...
if(length(custom_cols) > 0) {
  custom_reasons <- c(
    ...
    rep("Remove as explained by overview variable", sum(custom_cols == "outside_area_gilts_stable_TRUE")),
...
html_file <- file.path(output_dir, "SIV_BinaryPLSR_Subset_Analysis_Report.html")
