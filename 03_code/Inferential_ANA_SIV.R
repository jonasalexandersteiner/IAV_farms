...
exclude_vars_base <- c(
  ...
  "percentage_positive_pigs", "max_cp", "min_cp", "average_cp", "std_dev",
...
overview_dependent_vars <- c(
  ...
  "outside_area_farrowing_stable", "outside_area_weaner_stable", "outside_area_fattener_stable", "verification_contact_poultry_stable"
)
...
get_animal_vars <- function(exclude_vars) setdiff(
  c("Farrowing_on_farm", "Isemination_on_farm", "Gestation_on_farm", "Weaners_on_farm", "Fattening_on_farm", "symptomatic_report", "ili_signs", "return_to_service_rate", "farrowing_rate", "piglets_per_sow_year",
    ...
    "fatteners_reduced_general_wellbeing", "fatteners_sneezing",
...
ttest_vars <- c(
  ...
  "weaners_room_temperature","fatteners_qm_per_animal",
...
saveWidget(browsable(assoc_taglist), 
...
saveWidget(browsable(corr_taglist),
